...
void WCGB::letterFind (char letter, int position, vector <string> &deleteVec, int runtimeSize){
    int runTimes = 0;
...
void WCGB::greyFind (char letter, vector <string> &deleteVec, int runtimeSize){
    int runTimes = 0;
    for (int i = 0; i < runtimeSize; i++){
        string temp = deleteVec.at(i - runTimes);
        for (int j = 0; j < 5; j++){
...
void WCGB::yellowFind (char letter, int position, vector <string> &deleteVec, int runtimeSize){
    int runTimes = 0;
    for (int i = 0; i < runtimeSize; i++){
        string temp = deleteVec.at(i - runTimes);
        if (temp[position] == letter){
...
void WCGB::yellowfindMore (char letter, int position, vector <string> &deleteVec, int runtimeSize){
    int runTimes = 0;
    for (int i = 0; i < runtimeSize; i++){
        bool yellower = false;
        string temp = deleteVec.at(i - runTimes);
